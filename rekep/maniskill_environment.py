...
class R2D2Env:
    ...
    def update_robot_state(self):
        ...
        #     robot_state["joint_info"]["joint_positions"]
        # )
        #
        ...
        processed_obs = self.recursive_process_obs(obs)
        # 2 self.ee_position = np.array(robot_state["ee_info"]["position"])
        self.current_joint_angles = obs["agent"]["qpos"][0]
        # kk = obs.keys()
        self.ee_pose = obs["extra"]["tcp_pose"][0]
